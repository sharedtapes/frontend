...
//         var srcImg = '';
//         if (song.get('sources') !== undefined && song.get('sources').length > 0){
...
//         this.resultsStart = 0;
//         this.startLoading();
//         if ($("#query").val().indexOf('mixtape:') > -1){
//             $.get('/api/v1/tapes/' + $("#query").val().split(':')[1]).then(function(data){
//                 data = JSON.parse(data);
//                 this.stopLoading();
//                 this.songs.reset(data.songs);
//                 this.render();
